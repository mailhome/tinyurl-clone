...
export default function Hero() {
  return (
    <div className="lg:h-screen h-auto w-full bg-[#0D2342]">
        <div className="mx-auto h-full container px-5 lg:px-5 py-3 lg:pb-0 pb-20">
            <div className="flex flex-col items-start justify-start gap-y-10 lg:mt-10 py-5 w-full">
